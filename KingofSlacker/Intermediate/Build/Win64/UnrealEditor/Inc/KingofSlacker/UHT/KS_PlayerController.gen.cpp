...
AKS_PlayerController::AKS_PlayerController(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
...
struct Z_CompiledInDeferFile_FID_KingofSlacker_Source_KingofSlacker_Public_Gameplay_KS_PlayerController_h__Script_KingofSlacker_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AKS_PlayerController, AKS_PlayerController::StaticClass, TEXT("AKS_PlayerController"), &Z_Registration_Info_UClass_AKS_PlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AKS_PlayerController), 48077657U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_KingofSlacker_Source_KingofSlacker_Public_Gameplay_KS_PlayerController_h__Script_KingofSlacker_2647116342(TEXT("/Script/KingofSlacker"),
